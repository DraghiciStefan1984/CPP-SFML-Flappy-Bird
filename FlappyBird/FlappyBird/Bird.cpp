...
Bird::Bird(GameDataRef data):_data(data)
{
	...
	Vector2f origin = Vector2f(_birdSprite.getGlobalBounds().width / 2, _birdSprite.getGlobalBounds().height / 2);
...
void Bird::Draw() { _data->window.draw(_birdSprite); }
...
const Sprite & Bird::GetSprite() const { return _birdSprite; }